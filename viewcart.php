	...
	z-index: 500;
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Carts Page</h3>
        ...
        <?php 
		$viewcart =new Cart;
		$getcart=$viewcart->viewcart($_SESSION['user']);
		?>
		<?php
						...
						<div class="col-md-2"> <br><br><br><br><br><br><br><br><br><input class = "chose" value = "<?php echo $value['id'] ?>" style = "width:100px; height:50px" type="checkbox"></div>
							<div class="col-md-10 products-tabs" >
								<!-- tab -->
...
<?php
											...
											<a href='detail.php?id=$id&typeid=$typeid'><img style='width:200px' src='./img/$img' alt=''></a></h3>
												<div class='product-label'>
													<span class='sale'>-".$value['discountproducts']."</span>
											...
											<div class = 'sua'>
											<button class = 'but'>-</button><input class = 'int' value = '".$value['soLuong']."' type='text'><button class = 'but1'>+</button>
											</div> <br>
											</div>
										</div>
									</div>
	...
	<div>
		<div   class="kk col-md-12"><div></div> <button class ="delee" style="margin-left:400px; width=200px; height:30px">Delete</button> <button class ="buy" style="margin-left:500px; width=200px; height:30px">Buy</button></div>
	</div>
		<!-- /SECTION -->
