<?php include "headers.php"; ?>
		...
		<div class="section">
			...
			<div class="container">
				<!-- row -->
				<div class="row">
					<form action="checkgiohang.php?brand=<?php echo $_GET['brand']; ?>" method="post">
					<div class="col-md-7">
						<!-- Billing Details -->
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-col">
								...
								<div><strong><?php echo number_format($value['price'])."VND  X" ?><?php echo $value['soLuong'] ?></strong></div>
							</div>
							<?php }}}; ?>
							<div class="order-col">
								<div>Shiping</div>
						...
						<div class="payment-method">
							<div class="input-radio">
								...
								<div class="caption">
									<p>You will pay directly when you receive the goods.</p>
								</div>
							</div>
						</div>
						<div class="input-checkbox">
							<input type="checkbox" name="check" value = "yes" id="terms">
							<label for="terms">
								<span></span>
